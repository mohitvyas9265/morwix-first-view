...
const EPICS = {
  INFRA: '0. Infrastructure & DevOps',
  PLAT: '1. Core Platform & Auth',
  ONB: '2. School Onboarding',
  A: '3. Create Notice (Admin)',
  B: '4. Manage & Track Notices (Admin)',
  C: '5. Receive & Respond (Parent/Student)',
  D: '6. Notice Module — Branding & Overview',
  R2: '7. Future (R2 backlog)',
};
...
/* Seed data — the full from-scratch delivery plan: foundational infra/
   ...
   the R2 backlog. */
const SEED = [
  /* ---------------- 0. Infrastructure & DevOps ---------------- */
  { id:'INFRA-1', epic:'INFRA', priority:'high',
  ...
  { id:'INFRA-2', epic:'INFRA', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-3', epic:'INFRA', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-4', epic:'INFRA', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-5', epic:'INFRA', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-6', epic:'INFRA', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-7', epic:'INFRA', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-8', epic:'INFRA', priority:'medium',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-9', epic:'INFRA', priority:'medium',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-10', epic:'INFRA', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-11', epic:'INFRA', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-12', epic:'INFRA', priority:'medium',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-13', epic:'INFRA', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'INFRA-14', epic:'INFRA', priority:'medium',
  ...
  { id:'PLAT-1', epic:'PLAT', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'PLAT-2', epic:'PLAT', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'PLAT-3', epic:'PLAT', priority:'medium',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'PLAT-4', epic:'PLAT', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'PLAT-5', epic:'PLAT', priority:'medium',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'PLAT-6', epic:'PLAT', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'PLAT-7', epic:'PLAT', priority:'low',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'PLAT-8', epic:'PLAT', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'PLAT-9', epic:'PLAT', priority:'high',
  ...
  /* ---------------- 2. School Onboarding ---------------- */
  { id:'ONB-1', epic:'ONB', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'ONB-2', epic:'ONB', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'ONB-3', epic:'ONB', priority:'high',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'ONB-4', epic:'ONB', priority:'medium',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'ONB-5', epic:'ONB', priority:'medium',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'ONB-6', epic:'ONB', priority:'medium',
    ...
    status:'backlog', assignee:'Unassigned' },
  { id:'ONB-7', epic:'ONB', priority:'medium',
